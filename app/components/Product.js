    ...
    return (
        <>
            ...
            >
                ...
                {/* if product exists then display or not return null*/}
                ...
                <div className="pt-2 px-1">
                    ...
                    <div className="font-extrabold">
                        {/* /100 give decimal number eg- 1.333333.33*/}
                        £{(product?.price / 100).toFixed(2)}</div>

                    <div className="relative flex items-center text-[12px] text-gray-500">
                        <div className="line-through">
                            {/* /100 give decimal number and 1.2 for fake descount 20%*/}£{((product?.price * 1.2) / 100).toFixed(2)}</div>
